...
# --- Modelo fictício com duas classes, sem sobrescrever feature_importances_ ---
...
# --- Simular pesos por categoria fora do modelo ---
def simular_pesos():
    pesos = [0]*50
    pesos[0:10] = [0.02]*10        # Hard Skills
    pesos[10:20] = [0.015]*10      # Soft Skills
    pesos[20:30] = [0.01]*10       # Idiomas
    pesos[30:40] = [0.007]*10      # Formação
    pesos[40:50] = [0.005]*10      # Experiência
